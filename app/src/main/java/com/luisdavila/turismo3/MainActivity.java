...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opciones = new String[] {getResources().getString(R.string.Inicio),
                getResources().getString(R.string.hoteles), getResources().getString(R.string.bares),
                getResources().getString(R.string.lugares),getResources().getString(R.string.Demo)};
